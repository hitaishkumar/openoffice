...
export function PantryDetailsSheet() {
  const items = [
  ...
  return (
    <Sheet>
      ...
      <SheetContent side="right" className="min-w-5/6">
        <SheetHeader>
          <SheetTitle>Pantry Inventory</SheetTitle>
        </SheetHeader>
        <div className="h-full w-full">
          ...
          <div className="grid grid-cols-4 h-fit min-w-full">
            ...
            {/* RGIHT PANEL */}
            <div className="col-span-3 flex flex-col space-y-6 overflow-scroll p-2">
              {/* <FloorPlan /> */}
